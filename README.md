...
You can also think of this as my research into how an OS should be configured to maximize its:

- usability
- stability
- state separation and
- security
	* mainly by compartmentalization but also by memory safety.
...
- Minimal operating system itself, move as much to containers like Docker or Flatpak (or minimal-dependency binaries like Go can produce)
- Memory safety
